    ...
    <main className="page flex-center">
      <div className="blog-holder block center-relative content-1140 item-wrapped">
        ...
        >
          ...
          <div className="entry-holder" style={{ marginLeft: "40px"}}>
            {/* Article number */}
            <div className="post-num">
          ...
          <div className="info-wrapper info-wrapped">THE RESURGANCE OF THE DRAGONS. As things come to light, everything is cast into the dark. Traitors around every corner, monsters raining from the sky. The beloved 
            Second Moon was a shell that harbored the lost Dragons, and after all this time, the nightmares they endured are falling forth onto the planet Mune. <br/> <br/> 
